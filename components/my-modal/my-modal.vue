      ...
      <slot name="confirmButton">
        ...
        >
          <view
            ...
            :style="{
              marginRight:
                showCancelButton && showConfirmButton ? '22rpx' : '0rpx',
            ...
            @tap="cancelHandler"
          >
            <template v-if="useCancelLoading">
