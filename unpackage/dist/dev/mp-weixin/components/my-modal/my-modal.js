...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    p: common_vendor.t($props.confirmText),
    q: $props.confirmColor
  }, {
    r: common_vendor.n(!$props.showCancelButton && $props.showConfirmButton && "uv-modal__button-group__wrapper--only-confirm"),
    s: $props.confirmBgColor,
    t: common_vendor.o((...args) => $options.confirmHandler && $options.confirmHandler(...args))
  }) : {}, {
    v: $props.buttonReverse ? "row-reverse" : "row"
  }) : {}, {
    w: _ctx.$uv.addUnit($props.width),
    x: common_vendor.sr("modalPopup", "76772815-0"),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-76772815"], ["__file", "/Users/wei/cargo/components/my-modal/my-modal.vue"]]);
