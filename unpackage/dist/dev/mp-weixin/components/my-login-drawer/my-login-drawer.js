...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    async function nicknameSuccess(nickName) {
      ...
      try {
        await api_index.UptOwnerUserNickName({
          nickName
        });
    ...
    return (_ctx, _cache) => {
      return {
        a: common_vendor.sr(loginRef, "7dec6aba-0", {
          "k": "loginRef"
        }),
        b: common_vendor.o(loginSuccess),
        c: common_vendor.sr(nicknameRef, "7dec6aba-1", {
          "k": "nicknameRef"
        }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/wei/cargo/components/my-login-drawer/my-login-drawer.vue"]]);
