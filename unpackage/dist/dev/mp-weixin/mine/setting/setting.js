  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        g: common_vendor.o(($event) => toAgreement("ownerzc")),
        h: common_vendor.p({
          name: "arrow-right",
          color: "#A0AFBA",
          size: "24rpx"
        }),
        i: common_vendor.o(($event) => toAgreement("ownerxy")),
        ...
        l: common_vendor.sr(confirm, "78b76b94-5", {
          "k": "confirm"
        }),
        m: common_vendor.sr(nicknameRef, "78b76b94-6", {
          "k": "nicknameRef"
        }),
