  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        d: common_vendor.o(($event) => selectDate("start")),
        e: common_vendor.p({
          color: "#C8D4DF",
          length: "20rpx",
          margin: "0 20rpx"
        }),
        f: common_vendor.t(endDate.value || "结束时间"),
        g: !__props.disabled
      }, !__props.disabled ? {
        h: common_vendor.p({
          name: "arrow-down",
        ...
        i: common_vendor.o(($event) => selectDate("end")),
        j: common_vendor.sr(datetimePicker, "e25e4c9c-3", {
          "k": "datetimePicker"
        }),
        k: common_vendor.o(confirmDateTime),
        l: common_vendor.o(($event) => dateTime.value = $event),
        m: common_vendor.p({
          mode: "date",
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/wei/cargo/mine/statistics/components/my-datetime.vue"]]);
