<template>
  ...
  <view class="status-wrapper">
    ...
    <!-- <view class="tip">已停止派车，等待进行中运单任务的结束</view> -->
  </view>
  <!-- end -->
  <!-- 生产企业 -->
  ...
  <view
    ...
    v-if="info.MaterialsList && info.MaterialsList.length > 0"
  >
    <view
      class="material"
      :class="{ 'my-border-bottom': index < info.MaterialsList.length - 1 }"
      v-for="(item, index) in info.MaterialsList"
