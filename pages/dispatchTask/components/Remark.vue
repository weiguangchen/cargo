<template>
	<view @click="showDrawer">
		<uv-input v-model="text" input-align="right" placeholder="请输入" readonly border="none"
	...
	<!-- 填写备注 -->
	<my-drawer ref="drawer" title="填写备注" closeable showConfirmButton @confirm="confirm">
		<view style="padding:0 24rpx;">
			<uv-textarea maxlength="300" count v-model="remark" placeholder="请填写备注" border="none" height="308rpx" />
		</view>
	</my-drawer>
