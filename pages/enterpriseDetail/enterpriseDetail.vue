<template>
	...
	<!-- 导航 -->
	<uv-navbar :title="supply.Name" @leftClick="leftClick" :bgColor="`rgba(255,255,255,${ratio})`" :titleStyle="{
	...
	<view class="info-wrapper">
		...
		<view class="notice" @click="openNotice" v-if="supply.Notice">
			<uv-image src="/static/images/enterpriseDetail/notice.png" width="72rpx" height="40rpx" />
			<view class="content uv-line-1">{{ supply.Notice }}</view>
			<uv-image src="/static/images/enterpriseDetail/arrow.png" width="32rpx" height="32rpx" />
		</view>
		<view class="location">
			...
			<view class="handle-box">
				<view class="btn" @click="takePhone">
					<view class="round">
						<uv-image src="/static/images/enterpriseDetail/phone.png" width="48rpx" height="48rpx" />
					</view>
					<view>电话</view>
				</view>
				<view class="btn" @click="openMapApp">
					<view class="round">
						<uv-image src="/static/images/enterpriseDetail/location.png" width="48rpx" height="48rpx" />
					</view>
					<view>地图</view>
				</view>
			</view>
	...
	<uv-sticky index="cate" :customNavHeight="ctx.$uv.addUnit(customNavHeight)">
		<scroll-view class="categorys-list" scroll-x type="list" :show-scrollbar="false" enable-flex
			scroll-with-animation :scroll-into-view="intoView" scroll-into-view-alignment="center">
	...
	<!-- end -->
	<!-- 公告 -->
	<my-drawer ref="noticeDrawer" title="生产企业公告" closeable @change="e => show = e.show">
...
<script setup>
	...
	const dis = computed(() => {
		...
		if (!locationStore.location || !supply.value.Latitude || !supply.value.Logitude) return null;
