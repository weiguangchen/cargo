<template>
	...
	<view class="item-group">
		<view class="item my-border-bottom" hover-class="active" hover-start-time="0" hover-stay-time="200" @click="toAgreement('ownerzc')">
			<view class="label">隐私协议</view>
			<view class="value">
				<uv-icon name="arrow-right" color="#A0AFBA" size="24rpx"/>
			</view>
		</view>
		<view class="item" hover-class="active" hover-start-time="0" hover-stay-time="200" @click="toAgreement('ownerxy')">
